  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden w-full">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[600px] h-[300px] sm:h-[600px] bg-brand-600/15 dark:bg-brand-500/20 blur-[80px] sm:blur-[130px] rounded-full" />
        <div className="absolute top-1/3 -right-20 sm:right-10 w-[240px] sm:w-[400px] h-[240px] sm:h-[400px] bg-cyber-cyan/10 blur-[70px] sm:blur-[110px] rounded-full" />
      </div>
