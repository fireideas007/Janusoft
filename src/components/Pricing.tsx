...
export const Pricing: React.FC<PricingProps> = ({ onSelectPlan }) => {
  ...
  const plans: PricingPlan[] = [
    ...
    },
    {
      ...
      name: 'Custom Fullstack & AI Suite',
      price: 'Custom',
      period: 'tailored sprint',
      description: 'End-to-end multi-page web platform, custom AI chatbot assistant, webhook automations, and full database infrastructure.',
      bestFor: 'Startups & Growing Businesses',
      ctaText: 'Schedule Scoping Call',
      features: [
        'Complete Next.js web application + admin dashboard',
        'Custom AI chatbot trained on your company knowledge',
        'Automated WhatsApp & Email webhook notifications',
        'Supabase PostgreSQL database & auth setup',
        'Live production deployment on Vercel / Cloudflare',
        '30-day post-launch warranty & direct founder support',
      ],
    },
  ];
